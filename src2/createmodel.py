...
TEMPLATES = {
    1: [
        (
            ...
            "身の回り/安全",
            "○×",
            "小1 生活科：身の回りの安全やマナー。児童に分かりやすい○×問題を{N}問。JSON配列で。",
        ),
        (
            "国語",
            "ひらがな/語彙",
            "並べ替え",
            "小1 国語：ひらがなの並べ替え 2〜4文字を{N}問。JSON配列で。",
        ),
        (
            "算数",
            "10の合成",
            "穴埋め",
            "小1 算数：10の合成の穴埋めを{N}問。easy〜medium。JSON配列で。",
        ),
        (
            "算数",
            "一桁の加減",
            "計算",
            "小1 算数：一桁のたし算・ひき算を{N}問。JSON配列で。",
        ),
    ],
    2: [
        (
            ...
            "身近な規則/場面判断",
            "○×",
            "小2 生活科：身近な生活場面の○×を{N}問。JSON配列で。",
        ),
        (
            "国語",
            "短文読解(1-2文)",
            "○×",
            "小2 国語：やさしい短文読解の○×を{N}問。JSON配列で。",
        ),
        (
            "算数",
            "繰上/繰下の加減",
            "計算",
            "小2 算数：繰上がり/繰下がりの計算を{N}問。JSON配列で。",
        ),
        (
            "算数",
            "時計(5分刻み)",
            "3択",
            "小2 算数：○時○分の読み取り3択を{N}問。JSON配列で。",
        ),
    ],
    3: [
        (
            ...
            "九九",
            "穴埋め",
            "小3 算数：九九の穴埋めを{N}問。0や11以上は使わない。JSON配列で。",
        ),
        (
            "算数",
            "長さ/重さ(単位)",
            "換算",
            "小3 算数：mm,cm,m の換算問題を{N}問。JSON配列で。",
        ),
        (
            "理科",
            "身近な生物の特徴",
            "○×",
            "小3 理科：身近な生物の特徴に関する○×を{N}問。専門語は控えめ。JSON配列で。",
        ),
        (
            "社会",
            "地域の様子/暮らし",
            "3択",
            "小3 社会：地域の特色の基礎を3択で{N}問。最新時事依存NG。JSON配列で。",
        ),
        (
            "外国語活動",
            "聞く・話すの基礎",
            "反応",
            "小3 外国語活動：挨拶/自己紹介など聞く話す中心の短いやりとり課題を{N}問。文字使用は最小。JSON配列で。",
        ),
    ],
    4: [
        (
            ...
            "角度/分度器",
            "読み取り",
            "小4 算数：角度の読み取り/計算を{N}問。JSON配列で。",
        ),
        (
            "算数",
            "わり算の文章題",
            "文章題",
            "小4 算数：整数解の文章題を{N}問。JSON配列で。",
        ),
        (
            "国語",
            "ことわざ/慣用句",
            "意味3択",
            "小4 国語：ことわざ・慣用句の意味3択を{N}問。JSON配列で。",
        ),
        (
            "社会",
            "都道府県/地方",
            "3択",
            "小4 社会：地方区分・都道府県の基礎3択を{N}問。JSON配列で。",
        ),
        (
            "外国語活動",
            "場面会話",
            "反応",
            "小4 外国語活動：教室内の簡単な英語指示に反応する課題を{N}問。JSON配列で。",
        ),
    ],
    5: [
        (
            ...
            "小数/分数の計算",
            "計算",
            "小5 算数：小数・分数の四則混合を{N}問。既約分数or小数で。JSON配列で。",
        ),
        (
            "算数",
            "体積/容積(直方体)",
            "計算",
            "小5 算数：cm^3/m^3 の体積計算を{N}問。JSON配列で。",
        ),
        (
            "理科",
            "物の溶け方/濃度",
            "○×",
            "小5 理科：溶解と濃度の基礎○×を{N}問。JSON配列で。",
        ),
        (
            "社会",
            "産業(一次/二次/三次)",
            "3択",
            "小5 社会：産業の基礎3択を{N}問。JSON配列で。",
        ),
        (
            "外国語",
            "読む/書くの基礎",
            "穴埋め",
            "小5 外国語：語句の読み書き（アルファベット/単語）穴埋めを{N}問。JSON配列で。",
        ),
    ],
    6: [
        (
            ...
            "割合/比",
            "文章題",
            "小6 算数：割合・比の文章題を{N}問。JSON配列で。",
        ),
        (
            "算数",
            "比例/反比例",
            "関係",
            "小6 算数：比例・反比例の値当て/関係式を{N}問。JSON配列で。",
        ),
        (
            "理科",
            "電気回路の基礎",
            "○×",
            "小6 理科：電流・電圧・回路の基礎○×を{N}問。JSON配列で。",
        ),
        (
            "社会",
            "歴史(縄文〜江戸)",
            "3択",
            "小6 社会：基礎的事項の3択を{N}問。JSON配列で。",
        ),
        (
            "外国語",
            "短い読解/表現",
            "3択/記述",
            "小6 外国語：短い英文の理解や表現を{N}問。JSON配列で。",
        ),
    ],
}
...
def alignment_hint(subject: str, grade: int):
    if subject == "算数":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "算数 第2章",
            "notes": "数と計算/量と測定/図形/データの活用",
        }
    if subject == "国語":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "国語 第2章",
            "notes": "話す聞く/書く/読む/言語事項",
        }
    if subject == "理科":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "理科 第2章",
            "notes": "物質・エネルギー/生命/地球・宇宙/探究の過程",
        }
    if subject == "社会":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "社会 第2章",
            "notes": "地理/公民的分野（小）/歴史（高学年）",
        }
    if subject == "生活":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "生活 第2章",
            "notes": "身近な生活・安全・自然や人との関わり（1-2年）",
        }
    if subject == "外国語活動":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "外国語活動 第4章(3-4年)",
            "notes": "聞く・話す中心（読む書くは最小）",
        }
    if subject == "外国語":
        return {
            "framework": "MEXT-ES-2017",
            "chapter": "外国語 第4章(5-6年)",
            "notes": "読む・書くを含むコミュニケーション",
        }
    ...
    with open(combined, "w", encoding="utf-8") as f_all:
        for grade in range(1, 7):
            ...
            with open(out_path, "w", encoding="utf-8") as f_grade:
                for subject, unit, qtype, tmpl in tqdm(
                    TEMPLATES[grade], desc=f"G{grade}", unit="tmpl"
                ):
